...
void I_InitJoystick(void)
{
    ...
    {
        doomgeneric_printf("I_InitJoystick: Invalid joystick ID: %i\n", joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    if (joystick == NULL)
    {
        doomgeneric_printf("I_InitJoystick: Failed to open joystick #%i\n",
               joystick_index);
        SDL_QuitSubSystem(SDL_INIT_JOYSTICK);
        return;
    }
    ...
    {
        doomgeneric_printf("I_InitJoystick: Invalid joystick axis for joystick #%i "
    ...
    doomgeneric_printf("I_InitJoystick: %s\n", SDL_JoystickName(joystick_index));
